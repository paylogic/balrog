...
def test_filter(policy, identity, permission_name, objects):
    ...
    with mock.patch.object(balrog.Role, 'filter') as mock_filter:
        ...
        assert policy.filter(permission_name, objects, None, 1, 2, 3, a=1, b=2, c=3) == objects
        mock_filter.assert_called_once_with(identity, permission_name, objects, None, 1, 2, 3, a=1, b=2, c=3)
